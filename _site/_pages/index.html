...
<title>Zhifeng Wang - Homepage</title>
...
<meta property="og:site_name" content="Zhifeng Wang">
<meta property="og:title" content="Zhifeng Wang">
  ...
  <meta property="og:description" content="PHD Student of Machine Learning and Computer Vision in Australian National University.">
...
<div itemscope itemtype="http://schema.org/Person" class="profile_box">
  ...
  <div class="author__avatar">
    <img src="images/android-chrome-512x512.png" class="author__avatar" alt="Zhifeng Wang">
  </div>

  <div class="author__content">
    <h3 class="author__name">Zhifeng Wang</h3>
    <p class="author__bio">Australian National University</p>
  </div>
  ...
  <div class="author__urls-wrapper">
    ...
    <ul class="author__urls social-icons">
        ...
        <li><div style="white-space: normal; margin-bottom: 1em;">PHD Student of Machine Learning and Computer Vision in Australian National University. </div></li>
      
      
        <li><i class="fa fa-fw fa-map-marker" aria-hidden="true"></i> Canberra, Australia</li>
      
      
      
      
        <li><a href="mailto:zhifengwang19@gmail.com"><i class="fas fa-fw fa-envelope" aria-hidden="true"></i> Email</a></li>
        ...
        <li><a href="https://www.linkedin.com/in/zhifeng-wang-717606101"><i class="fab fa-fw fa-linkedin" aria-hidden="true"></i> LinkedIn</a></li>
        ...
        <li><a href="https://scholar.google.com/citations?user=Uh7R-acAAAAJ&hl=zh-CN"><i class="fas fa-fw fa-graduation-cap"></i> Google Scholar</a></li>
      ...
      <div class="author__urls_sm">
        ...
        <a href="mailto:zhifengwang19@gmail.com"><i class="fas fa-fw fa-envelope" aria-hidden="true"></i></a>
        ...
        <a href="https://www.linkedin.com/in/zhifeng-wang-717606101"><i class="fab fa-fw fa-linkedin" aria-hidden="true"></i></a>
        ...
        <a href="https://scholar.google.com/citations?user=Uh7R-acAAAAJ&hl=zh-CN"><i class="fas fa-fw fa-graduation-cap"></i></a>
...
<!-- 5 paper -->
<div class="paper-box"><div class="paper-box-image"><div><div class="badge">Neurocomputing 2023</div><img src="images/micro-architecture.jpg" alt="sym" width="100%" /></div></div>
<div class="paper-box-text">
...
<ul>
  <li><em>2021.10</em> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus ornare aliquet ipsum, ac tempus justo dapibus sit amet.</li>
  <li><em>2021.09</em> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus ornare aliquet ipsum, ac tempus justo dapibus sit amet.</li>
</ul> -->
...
<ul>
  <li><em>2024.10</em>, SoV Prompting: Enhancing Vision Large Language Models for Zero-Shot Emotion Recognition with Spatial Visual Prompts.</li>
  <li><em>2024.06</em>,  A diffusion-based framework for enhancing facial expression recognition in extremely low-light environments through label-aware embeddings and transformer networks. </li>
...
<ul>
  <li><em>2019.05 - 2020.02</em>, <a href="https://github.com/">Lorem</a>, China.</li>
</ul> -->
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-R9GF70XR2E"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', "G-R9GF70XR2E");
</script>
